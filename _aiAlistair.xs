...
runImmediately
{
    ...
    MaintainHouses();
    MaintainMarket();
    MaintainCommandPosts();
    MaintainTowers();
    MaintainInfantryBuildings();
    MaintainCavalryBuildings();
    MaintainArtilleryBuildings();
    MaintainMercenaryBuilding();
    MaintainReligiousBuildings();
    MaintainCherryOrchards();
    MaintainMangoGroves();
    MaintainLumberCamps();
    MaintainFactories();
    MaintainDutchBanks();
    ...
    MaintainFirePit();
    MaintainDojos();
    MaintainEuropeanArsenal();
    MaintainOttomanArsenal();
    MaintainAsianArsenal();
    MaintainCapitol();
    MaintainFarms();
    MaintainPlantations();
    MaintainFortFrontiers();
    MaintainVillagers();
    MaintainMainMilitaryUnits();
    MaintainArtilleryUnits();
    MaintainConsulateArmies();
    MaintainFameUnits();
    ResearchEconomicTechs();
    ResearchUnitUpgrades();
    MaintainTradingPosts();
    MaintainNativeWarriors();
    AutoGatherMilitary();
    DefendMainBase();
    ManageAttackWaves();
    RingTheBell();
    ...
    DanceToFirepit();
    ShouldIResign();
    ExploreLandWithSpecialScouts();
    RescueKnockedOutUnits();
    ManageRicePaddyTactics();
    HideTheRegent();
}
